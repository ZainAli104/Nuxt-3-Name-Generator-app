<template>
  <div class="container">
    ...
    <p>Choose your option by just click the buttons below!</p>
    ...
    <div class="cards-container">
      <div v-for="name in seletedNames" :key="name" class="card">
        <h4>{{ name }}</h4>
        <p></p>
      </div>
    </div>
...
const computeSelectedNames = () =>{
  ...
  seletedNames.value = filteredNames.map((name) => name.name)
}

const seletedNames = ref<string[]>([])
</script>
